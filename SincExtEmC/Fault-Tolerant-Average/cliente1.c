...
int main(){
    ...
    while(1){
        ...
        //tenho que enviar o currente time para o servidor 
        //para ele enviar para os outros nós


        valread =  sendto(sockfd,(struct tm *)current_time,(int ) sizeof(current_time),0, (struct sockaddr *)&serv_addr,fromlen);
        if(valread < 0){
        ...
        //tenho que inserir o tempo de todos os coutros nós
